<x-admin-master>
 ...
 <p><a href="{{url('admin')}}">Dashboard</a> / <a href="{{url('admin/lastyear/create')}}">  Al-Madinah International University Alumni Membership Form / استمارة عضوية نادي الخريجين في جامعة المدينة العالمية </a> </p>
        <hr>
								...
								<div class="row justify-content-center mb-5 mt-4">
										...
										<h3>خاصة بطلاب السنة الآخيرة <strong>

				      					<br>Exclusive for Final Year Students</strong></h3><br><br>
						
								</div>
									<!-- Start Alumni Form -->
								
								<form id="alumniform" method="POST" action="{{route('lastyear.store')}}">
										@csrf
							...
							<div class="col text-center mb-3">
								...
								<div class="form-group">
									<div class="form-check">
										...
										<input class="form-check-input" type="checkbox" name="termsCondtions" value="yes" data-toggle="modal" data-target="#termsCondtionsModel" >
